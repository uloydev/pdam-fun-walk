                                        ...
                                        <div class="flex items-center px-2 py-1">
                                            <div class="ml-6">
                                                <p
                                                    ...
                                                    Size</p>
                                                <h6 class="mb-0 text-2xl leading-normal dark:text-white">{{$item->size}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                        ...
                                        <div class="text-center">
                                            <p
                                                class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">
                                                Used Quota</p>
                                            <h6 class="mb-0 text-lg leading-normal dark:text-white">{{$item->used_stock}}</h6>
                                        </div>
                                    </td>
                                    <td
                                        class="p-2 align-middle bg-transparent border-b whitespace-nowrap dark:border-white/40">
                                        <div class="text-center">
                                            <p
                                                class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">
                                                Remaining Quota</p>
                                            <h6 class="mb-0 text-lg leading-normal dark:text-white">{{$item->remaining_stock}}</h6>
                                        </div>
                                    </td>
                                    <td
                                        ...
                                        <div class="flex-1 text-center">
                                            <p
                                                class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">
                                                Total Stock</p>
                                            <h6 class="mb-0 text-lg leading-normal dark:text-white">{{$item->total_stock}}</h6>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
